...
/**
 * Teste com API Fake: https://jsonplaceholder.typicode.com/comments
 */
function fraseAleatoria() {
    $("#spinner").toggle();
    $.get("https://jsonplaceholder.typicode.com/comments", trocaFrase)
    .fail(function() {
        setTimeout(function() {
            $("#erro").toggle();
        }, 1500);
...
function buscaFrase() {
    ...
    $.get("https://jsonplaceholder.typicode.com/comments", dados, trocarFrase)
    .fail(function() {
        setTimeout(function() {
            $("#erro").toggle();
        }, 1500);
